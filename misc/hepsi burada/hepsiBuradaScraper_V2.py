...
print('Now visiting each products webpage individually. This may take 14-18 minutes')
...
## there were some URLs with faulty HTML description. deleting those entries
faulty_urls = ['https://www.hepsiburada.com/garmin-instinct-akilli-saat-ates-kirmizisi-p-HBV00000M9EFA?magaza=First%20Sourcer',
              ...
              'https://www.hepsiburada.com/garmin-vivoactive-3-muzik-akilli-saat-p-HBV00000CJHAR?magaza=First%20Sourcer',
               'https://www.hepsiburada.com/garmin-instinct-akilli-saat-sari-p-HBV00000M9EFD?magaza=First%20Sourcer'
             ]
...
df.to_csv('HepsiBurada Complete V2.csv')

print('\n\nExtraction completed successfully and results stored in HepsiBurada Complete V2.csv\n')
